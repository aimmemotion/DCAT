...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='dcat', type=str, metavar='MODEL',
    ...
    parser.add_argument('--data-path', default=os.path.join(os.path.expanduser("~"), 'datasets/image_cls/imagenet1k/'), type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='GAF', choices=['CIFAR10', 'CIFAR100', 'IMNET', 'INAT', 'INAT19', 'GAF', 'GroupEmoW'],
    ...
    parser.add_argument('--load_pretrained', type=str, default='', help='path to the pretrained model')
    
    # MIP data path
    parser.add_argument('--mip_root_train', default='', type=str, help='dataset path')
    parser.add_argument('--mip_cropped_root_train', default='', type=str, help='dataset path')
    parser.add_argument('--mip_txt_root_train', default='', type=str, help='dataset path')
    parser.add_argument('--mip_root_val', default='', type=str, help='dataset path')
    parser.add_argument('--mip_cropped_root_val', default='', type=str, help='dataset path')
    parser.add_argument('--mip_txt_root_val', default='', type=str, help='dataset path')
    
    parser.add_argument('--mip_select', action='store_true', help='mip select (default: false)')
    parser.add_argument('--mip_keep_ratio', type=float, default=1.0, metavar='MKR', help='mip keep ratio (default: 1.0)')
    parser.add_argument('--full_select', action='store_true', help='full select (default: false)')
    parser.add_argument('--full_keep_ratio', type=float, default=1.0, metavar='FKR', help='full keep ratio (default: 1.0)')
...
def main(args):
    ...
    print("nb_classes = {}".format(args.nb_classes))
    ...
    model = create_model(
        ...
        mip_keep_ratio=args.mip_keep_ratio, 
        full_select=args.full_select, 
        full_keep_ratio=args.full_keep_ratio,
    ...
    if args.load_pretrained:
        ...
        crossvit_pretrained = 'https://github.com/IBM/CrossViT/releases/download/weights-0.1/crossvit_18_dagger_224.pth'
        checkpoint_model = torch.hub.load_state_dict_from_url(crossvit_pretrained, map_location='cpu')
